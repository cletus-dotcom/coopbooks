...
SOFTWARE_TYPE = "Customized / Off-the-shelf"
DATABASE_PLATFORM = "PostgreSQL 14+"
TECH_STACK = "Python 3.11+, Flask 3.x, SQLAlchemy, Bootstrap 5"
...
BIR_CAS_REQUIREMENTS = [
    ...
    },
    {
        ...
        "description": (
            "Complete list of system features and modules such as General Ledger, "
            "Accounts Payable, Inventory, and cooperative-specific modules."
        ),
    },
    {
        "slug": "sample-layouts",
        ...
        "description": (
            ...
            "General Journal, Sales/Purchase Journals, Trial Balance, and Ledger."
        ),
    },
    {
    ...
    },
    {
        ...
        "description": (
            "Procedures for data backup, restoration, and ten-year record retention "
